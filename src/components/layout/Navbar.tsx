...
const NAV_ITEMS = [
  { path: '/basics', ko: '회계 기초', en: 'Basics' },
  { path: '/financial-statements', ko: '재무제표', en: 'Statements' },
  { path: '/bookkeeping', ko: '부기', en: 'Bookkeeping' },
  { path: '/cost-accounting', ko: '원가회계', en: 'Cost' },
  { path: '/tax', ko: '세무회계', en: 'Tax' },
  { path: '/management-accounting', ko: '관리회계', en: 'Mgmt' },
  { path: '/auditing', ko: '감사', en: 'Auditing' },
  { path: '/financial-analysis', ko: '재무분석', en: 'Analysis' },
];
      ...
      <nav className={`navbar ${isScrolled ? 'scrolled' : ''}`}>
        <div className="navbar-inner">
          <Link to="/" className="navbar-logo">
            <span className="logo-study">Accounting</span>
            <span className="logo-master">Guide</span>
          </Link>
